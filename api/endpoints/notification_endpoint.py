...
async def get_notifications_endpoint(
    ...
    notifs, total = await notification_service.get_notifications(user_id, client_id, limit, offset)
...
async def mark_as_read(
    ...
    return await notification_service.mark_notification_as_read(notification_id, user_id, client_id=client_id)
...
async def clear_notifications(
    ...
    user_id = UUID(receiver_id)
    return await notification_service.soft_delete_all_by_receiver(user_id, client_id=client_id)
