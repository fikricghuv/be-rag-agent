...
KNOWLEDGE_PDF_TABLE_NAME = os.getenv("KNOWLEDGE_PDF_TABLE_NAME")
KNOWLEDGE_WEB_TABLE_NAME = os.getenv("KNOWLEDGE_WEB_TABLE_NAME")
COMBINED_KNOWLEDGE_TABLE_NAME = os.getenv("COMBINED_KNOWLEDGE_TABLE_NAME")
...
CLIENT_ID_BRINS = os.getenv("CLIENT_ID_BRINS")
CLIENT_ID_TALKVERA = os.getenv("CLIENT_ID_TALKVERA")